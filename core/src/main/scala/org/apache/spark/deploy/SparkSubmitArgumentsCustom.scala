...
private[deploy] class SparkSubmitArgumentsCustom
(args: Seq[String], env: Map[String, String] = sys.env)
  ...
  var listExceptions: java.util.ArrayList[String] = new java.util.ArrayList[String]()
  ...
  {
    val listString = String.join("\n", listExceptions)
    throw new SparkException(listString);
  }
  ...
  override protected def handleUnknown(opt: String): Boolean = {
    if (opt.startsWith("-")) {
      ...
      listExceptions.add(s"Unrecognized option '$opt'.");
      return false;
    }
